...
def load_splits():
    with open('../data/MSR-VTT/metadata/train_r3.list', 'r') as fin:
        train_vids = json.load(fin)
    with open('../data/MSR-VTT/metadata/valid_r3.list', 'r') as fin:
        val_vids = json.load(fin)
    with open('../data/MSR-VTT/metadata/test_r3.list', 'r') as fin:
